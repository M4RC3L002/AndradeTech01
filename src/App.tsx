...
function LoginScreen({ onLoginSuccess }: { onLoginSuccess: () => void }) {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center p-4 bg-[#0a0a0a]">
      <div className="w-full max-w-sm rounded-2xl border p-6 shadow-2xl bg-[#111] border-neutral-800">
        ...
        <form onSubmit={handleLogin} className="space-y-4">
          <div>
            ...
            <input
              ...
              className="w-full rounded-lg border px-3 py-2 text-sm outline-none bg-[#181818] border-neutral-800 text-neutral-200"
            />
          </div>
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full rounded-lg py-2.5 text-sm font-semibold text-white transition-all bg-blue-600 hover:bg-blue-500 disabled:opacity-50"
          >
...
function WhatsAppBtn({
  ...
  return (
    <a
      ...
      className="inline-flex flex-shrink-0 cursor-pointer items-center gap-1 rounded-full px-2.5 py-1.5 text-xs font-semibold text-white transition-all bg-[#25D366] hover:opacity-90 active:scale-95"
    >
